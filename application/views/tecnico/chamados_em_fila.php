                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td><?=$chamado->setor;?></td>							
                            <td>
							<button class="btn btn-light btn-sm" onclick="emAndamento(<?=$chamado->id;?>)"><i class="far fa-calendar-check text-success"></i></button>
							<button class="btn btn-light btn-sm" data-toggle="modal" data-target="#cancelar" onclick="enviaIdCancela(<?=$chamado->id;?>)"><i class="far fa-calendar-times text-danger"></i></button>
							</td>                            
                        </tr>
						<?php } ;?>
