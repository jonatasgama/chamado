                ...
                <form>
					...
					<div class="row">
						...
						<label for="solicitacao">Solicitação</label>
							...
							<input type="hidden" name="id_usuario" id="id_usuario" value="<?=$this->session->userdata('id');?>">
							<div class="float-right mt-3 mb-3">
								<button type="button" onclick="envia()" class="btn btn-success">Enviar</>
							</div>
						</div>				
					</div>					
                </form>
				<div class="loader col-3 offset-5" id="loader" style="display:none;"></div>
            </div>
		</div>	
	</div>
